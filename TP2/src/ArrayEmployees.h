...
/**
 * @fn void MostrarTotalYPromedioDeSalarios(Employee[], int)
 * @brief
 * muestra la suma de los salarios, el promedio entre ellos y la
 * cantidad de empleados que superan ese promedio
 * @param list lista de empleados
 * @param tam tamaño de la lista de empleados
 */
void MostrarTotalYPromedioDeSalarios(Empleado list[], int tam);
