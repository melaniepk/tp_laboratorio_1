...
int ll_clear(LinkedList* this)
{
    ...
    if(this!= NULL)
    {
    	...
    	{
    		ll_remove(this,0);// elimina siempre la posicion 0, que cada vez corresponde a un elemento distinto porque la lista se achica
    	}
    	returnAux = 0;
    }
...
int ll_isEmpty(LinkedList* this)
{
    ...
    {
    	returnAux = 1;
    	if(ll_len(this)) // si tiene algo retorna 0
    	{
    		returnAux =0;
    	}
